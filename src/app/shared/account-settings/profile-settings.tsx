...
import AvatarUpload from "@/utils/file-upload/avatar-upload";
import FormFooter from "@/utils/form-footer";

const QuillEditor = dynamic(() => import("@/utils/quill-editor"), {
  ssr: false,
});
            ...
            <>
              ...
              >
                <div className="w-full sm:w-auto md:ms-auto">
                  <Link href={routes.profile.profileSettings}>

...
//                     sh 'yarn test'
            ...
            steps { 
                ...
                script{
                    ...
                    if (env.BRANCH_NAME == 'master') {
                        app = docker.build("registry.gitlab.com/kevmaxsarl/pos/app:latest", "-f ${dockerfile} ./")
                    } else {
                        app = docker.build("registry.gitlab.com/kevmaxsarl/pos/app:"+env.BRANCH_NAME, "-f ${dockerfile} ./")
                    }
                }
            }
        }
        ...
        stage('Deploy') {
            steps {
                script{
                    docker.withRegistry('https://registry.gitlab.com/kevmaxsarl/pos/app', 'gitlab_username_password') {
